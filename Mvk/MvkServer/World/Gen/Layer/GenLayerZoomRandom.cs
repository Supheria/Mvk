...
namespace MvkServer.World.Gen.Layer
{
    ...
    public class GenLayerZoomRandom : GenLayer
    {
        ...
        public override int[] GetInts(int areaX, int areaZ, int width, int height)
        {
            ...
            for (z = 0; z < ph - 1; z++)
            {
                ...
                for (x = 0; x < pw - 1; x++)
                {
                    ...
                    ar[idx] = old1;
                    ar[idx + nw] = SelectRandom(old1, old2);
                    ar[idx + 1] = SelectRandom(old1, old3);
                    ar[idx + 1 + nw] = SelectModeOrRandom(old1, old3, old2, old4);
                    idx += 2;
                    old1 = old3;
                    old2 = old4;
                }
        ...
        /// </summary>
        private int SelectRandom(params int[] args) => args[NextInt(args.Length)];

        /// <summary>
        /// Возвращает наиболее часто встречающееся число набора или случайное число из предоставленных
        /// </summary>
        private int SelectModeOrRandom(int param1, int param2, int param3, int param4)
        {
                                        ...
                                        ? param1 : (param2 == param3 && param1 != param4
                                            ? param2 : (param2 == param4 && param1 != param3
                                                ? param2 : (param3 == param4 && param1 != param2
                                                    ? param3 : SelectRandom(param1, param2, param3, param4)
                                                )))))))));
        }
    }
}
